/*
  ...
  */;
  ...
  AppRate = (function() {
    ...
    PREF_STORE_URL_PREFIX_IOS11 = "itms-apps://itunes.apple.com/xy/app/foo/id";
    PREF_STORE_URL_POSTFIX = "?action=write-review";
    ...
    AppRate.showNativeIOSRatingPrompt = function() {
      if (counter.countdown === AppRate.preferences.usesUntilPrompt) {
        updateCounter('reset');
      ...
      if (/(iPhone|iPod|iPad)/i.test(navigator.userAgent.toLowerCase())) {
        if (this.preferences.inAppReview) {
          ...
          if (iOSVersion < 9) {
            ...
            iOSStoreUrl = PREF_STORE_URL_PREFIX_IOS11 + this.preferences.storeAppURL.ios + PREF_STORE_URL_POSTFIX;
          } else {
            iOSStoreUrl = PREF_STORE_URL_PREFIX_IOS9 + this.preferences.storeAppURL.ios + PREF_STORE_URL_POSTFIX;
          }
